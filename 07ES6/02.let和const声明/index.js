...
console.log("7. let内部定义的变量在外部不能访问,var就可以");
for (var i = 0; i < 10; i++) {
    console.log(i); //  0 ~ 9
}
console.log(i); //  10
...
// 8. 如果在循环体内设置函数方法，循环体外输出 var 会得到不想要的值；
console.log("8. 如果在循环体内设置函数方法，循环体外输出 var 会得到不想要的值");
console.log("var");
var list = [];
for (var k = 0; k < 10; k++) {
