...
class Children1 extends Person {
...
class Children2 extends Person2 {
    ...
    static go() {
        ...
        //return 'o o o ' + Person2.gender; //这里使用Person2和Children2是不一样的
        return 'o o o ' + Children2.gender; //这里使用Person2和Children2是不一样的
    }
}
...
console.log(Children2.go()); //o o o 男
