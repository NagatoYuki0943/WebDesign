...
console.log("1. ES6 提供了 u 修饰符，对占两个字符特殊字进行正则识别")
...
console.log("2. ES6 提供了 y 修饰符，它的作用是当匹配过一次后继续往下匹配")
let text = 'xxx_xx_x_'
...
console.log("3. 对于 y 修饰符，ES6 提供了 stikcy 属性，用来检测是否存在 y 修饰符")
console.log(patt.sticky); // true



// 4. ES6 提供了 flags 属性，用于返回正则使用的修饰符名称；
console.log("4. ES6 提供了 flags 属性，用于返回正则使用的修饰符名称")
...
// 5. .表示匹配所有，除了终止符，比如回车\n 换行\n 等等，使用 s 修饰符匹配可以匹配它们；
console.log("5. .表示匹配所有，除了终止符，比如回车\n 换行\n 等等，使用 s 修饰符匹配可以匹配它们")
text = 'x\nyz';
patt = /x.+yz/;
