...
console.log("1. ES6 提供了 Object.is()方法来解决 '===' 中一些恒等中的缺点");
...
console.log("2. ES6 提供了 Object.assign()方法可以合并指定对象至目标对象内部")
...
console.log(obj1); // Object { name: "Mr Lee", age: 100 }
console.log(obj2); // Object { name: "Mr Wang", age: 200 }

// 参数1: 目标对象;  参数2,3: 替换的对象
Object.assign(obj1, obj2)
console.log(obj1); // Object { name: "Mr Wang", age: 200 }
console.log(obj2); // Object { name: "Mr Wang", age: 200 }
...
console.log(obj1); // Object { name: "Mr Wang", age: 200, gender: "male" }
console.log(obj2); // Object { name: "Mr Wang", age: 200 }
console.log(obj3); // Object { gender: "male" }
...
console.log("3. ES6 提供了 Object.getPrototypeOf()和 Object.setPrototypeof()方法")
let obj4 = {
    fn() {
        return 'fn1'
    }
...
console.log("4. ES6 提供了 super 关键字，用于原型中方法的继承功能")
let obj6 = {
    fn() {
        return 'fn';
    }
