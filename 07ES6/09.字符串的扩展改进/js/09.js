...
console.log(text1.charCodeAt(0)); //63
console.log(text1.charCodeAt(1)); //NaN 第二个字
console.log(text1.codePointAt(0)); //63 十进制码点
console.log('=======================');
...
console.log(text.startsWith('Mr.')); //false,从头找字符串是否存在
console.log(text.endsWith('Mr.')); //false,从结尾找字符串是否存在
