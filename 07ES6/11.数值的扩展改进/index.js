...
console.log("1. ES6 明确二进制、八进制和十六进制分别用 0b、0o、0x 作为前缀")
...
console.log("2. ES6 提供了 Number.isFinite()、Number.isNaN()判断无穷大和 NaN")
...
console.log("3. ES6 提供了 Number.parseInt()、Number.parseFloat()转换整型和浮点型\n直接使用parseInt(),parseFloat()函数也可以")
...
console.log("4. ES6 提供了 Number.isInteger()，来判断参数是否是一个整型")
...
console.log("5. ES6 提供了一个常量，值特别小，用于判断是否得到正确结果")
...
console.log("6. ES6+新增了一个指数运算符 **，并且可以进行赋值运算")
console.log(2 ** 4); // 16
let num = 2;
num **= 5;
console.log(num); // 32
