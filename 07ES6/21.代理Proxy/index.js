...
// 参数 1 拦截的目标对象，参数 2 拦截行为
// 参数 2 如果是空对象，代理直接会调用目标对象
console.log("4. 如果想让代理对象公布出合适的信息，可以通过 get() 来实现；")
...
console.log("5. 我们也可以通过 set() 方法来对代理对象的属性进行赋值");
...
// 赋值失败
p2.age = -1; // Uncaught TypeError: 年龄不合法
